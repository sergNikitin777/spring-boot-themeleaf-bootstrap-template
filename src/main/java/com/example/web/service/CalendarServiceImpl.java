...
public class CalendarServiceImpl implements CalendarService {
    ...
    @Override
    public List<VTimeZone> findAllTimeZones(String caldavHost, Integer caldavPort, String protocol, String username, String password, String calPrefix, String calPostfix) {
        List<VTimeZone> vTimeZones = new ArrayList<>();
        ...
        try {
            ...
            for (Calendar calendar : calendars) {
                ComponentList componentList = calendar.getComponents().getComponents(Component.VTIMEZONE);
                Iterator<VTimeZone> eventIterator = componentList.iterator();
                while (eventIterator.hasNext()) {
                    VTimeZone ve = eventIterator.next();
